...
import uk.co.coroutines.enviropi.Resources.colors
import uk.co.coroutines.enviropi.Resources.fractions
        ...
        display.display(
            BufferedImage(imageWidth, imageHeight, TYPE_USHORT_565_RGB).apply {
              createGraphics().run {
                ...
                val points =
                    temperatures.flatMapIndexed { index, y ->
